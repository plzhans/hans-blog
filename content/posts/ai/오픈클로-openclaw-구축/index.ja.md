...
![onboardの最初のステップにあるセキュリティ警告同意画面](./assets/3_30d22a0f-7e83-808b-b444-f99cdc23c20e.png)
...
>
>
> ![チャットボットにファイルを要求すると内容をそのまま出力する例の画面](./assets/4_31022a0f-7e83-80dc-a51c-c26d7be8c0f0.png)
>
>
> </details>
...
![onboardでインストールモードを選択する画面](./assets/5_30d22a0f-7e83-8014-b12d-d1e1b342ba91.png)
...
>
>
> ![ワークスペースのパスを指定する画面](./assets/8_30d22a0f-7e83-8045-8f43-f8e216bb19b0.png)
>
>
> </details>
...
![使用するモデルと認証プロバイダーを選択する画面](./assets/9_30d22a0f-7e83-804c-aba4-d28f3ce24fa0.png)
...
![接続するメッセンジャーチャンネルを選択する画面](./assets/13_30d22a0f-7e83-807b-978a-fc624c5ddcf8.png)
...
>
>
> ![Telegramの@BotFatherと会話してボットを作成する画面](./assets/15_30d22a0f-7e83-80a3-9025-e1fc0a7cdeb9.png)
>
>
...
![使用するスキルを選択する画面](./assets/18_30d22a0f-7e83-802c-9003-d2e265d919f2.png)
...
>
>
> ![Gemini(Nano Banana)の画像生成スキルを設定する画面](./assets/21_30d22a0f-7e83-8057-aeeb-cab0cf88d3b0.png)
>
>
> **Notion**
>
...
>
>
> ![音声をテキストに変換するWhisper(STT)設定画面](./assets/24_30d22a0f-7e83-809b-a7bb-d0ac4824e529.png)
>
>
> **ElevenLabs（TTS）**
>
...
>
>
> ![テキストを音声に変換するElevenLabs(TTS)設定画面](./assets/25_30d22a0f-7e83-801d-b123-e98305c4cc29.png)
>
>
> </details>
...
![使用するHookを選択する画面](./assets/26_30d22a0f-7e83-80f4-ba8e-f046b7b530b2.png)
...
>
>
> ![Telegramで受け取った認証コードをターミナルに入力する画面](./assets/31_30d22a0f-7e83-8056-af82-d77955b2432a.png)


### 9. 自分の名前とボット名を決める


![ユーザーの呼び方とボット名を決める画面](./assets/32_31022a0f-7e83-80a0-b6de-e328656450d4.png)
