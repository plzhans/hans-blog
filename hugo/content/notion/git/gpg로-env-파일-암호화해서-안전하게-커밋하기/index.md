...
설치/키 생성은 [github에서 GPG로 git 커밋 서명하기](https://www.notion.so/30922a0f7e838081983ad8ba3c21ba28) 문서를 참고하세요.
...
- 원본 파일이 **이미 과거 커밋에 포함**된 적이 있다면, `.gitignore`에 추가해도 **과거 커밋에서 평문을 열 수 있습니다.**
- 완전히 없애려면 비밀값을 **폐기/재발급**하고, 히스토리를 **재작성**해야 합니다.
...
- 출력 파일이 이미 있을 때 덮어쓰려면 `--yes` 옵션을 사용합니다.
