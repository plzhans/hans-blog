...
lastmod: 2026-02-16T17:49:00.000Z
toc: true
draft: false
images:
...
설치/키 생성은 [github에서 GPG로 git 커밋 서명하기](../88-github-gpg-commit-signing/) 문서를 참고하세요.
...
- **이미 과거 커밋에 포함**된 적이 있다면 `.gitignore`에 추가해도 **과거 커밋에서 평문을 열 수 있습니다.**
